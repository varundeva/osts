...
<div class="bg-image"></div>
  ...
  <h1 class="h3 mb-3 font-weight-normal text-center text-white">OSTS Users Login</h1>
...
<div class="form-group">
  ...
  <p class="text-center text-white">Not Registerd? Register Now <a href="register.php">Click Here</a></p>
